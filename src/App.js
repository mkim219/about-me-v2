          ...
          <div className="row">
            ...
            <div className="col-lg-4 mb-4">
              <div className="card w-100">
                <img className="card-img-top" src={require('./assets/OAP/oap-box-logo.jpeg')} alt="Card image cap"/>
            ...
            <div className="col-lg-4 mb-4">
              <div className="card">
                <div className="d-block align-content-center bg-black" style={{ height: "414px" }}>
                  <img className="card-img-top img-fluid " src={Cleantopia} alt="Card image cap"/>
                </div>
                <div className="card-body">
            ...
            <div className="col-lg-4 mb-4">
              <div className="card">
                <div className="d-block align-content-center bg-black" style={{ height: "414px" }}>
                  <img className="card-img-top" src={EngineX} alt="Card image cap"/>
                </div>
                <div className="card-body">
